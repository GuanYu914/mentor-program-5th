...
// 先做查詢
/*
const getURL = encodeURI(`http://${username}:${password}@lidemy-http-challenge.herokuapp.com/api/v2/books?q=我`) // 使用 encodeURI 解決 URL 有中文無法正常運作
// console.log(url);
...
// 再做更新書籍資訊
/*
const patchURL = `http://${username}:${password}@lidemy-http-challenge.herokuapp.com/api/v2/books/72`
